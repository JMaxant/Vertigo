<footer class="container">
       ...
       <?php
            ...
            if ( has_custom_logo() ) {
                 echo '<a href=http://steven-luu.com/wordpress/><img src="'. esc_url( $logo[0] ) .'"></a>';
            }
            ?>
            <nav id=footer-menu>
                 <ul>
                      ...
                      <li><a href="https://www.scoop.it/t/le-groupe-vertigo">Presse</a></li>
                 </ul>
            </nav>
                      ...
                      <div id="social" class="modal fade" tabindex="-1" role="dialog">
                           <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                     ...
                                     <div class="modal-body">
                                          <p>placeholder for social networks.</p>
